...
Version  : 1.2.1
Release  : 71
URL      : https://cran.r-project.org/src/contrib/uuid_1.2-1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/uuid_1.2-1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722280504
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/uuid/libs/uuid.so
/V4/usr/lib64/R/library/uuid/libs/uuid.so
